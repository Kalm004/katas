...
// on their phones -- everytime you press the button it sends you an array of one-letter strings representing
...
export function isTenMinuteWalk(directions: string[]) : boolean {
    return false;
}